...
const Color bottomcheckoutcolor = Color.fromARGB(255, 173, 86, 31);
...
const Color cookinginstructiontextcolor = Colors.white;
...
const Color drawerscreenboxdeclineargradient1 =
    Color.fromARGB(117, 241, 216, 165);
const Color drawerscreenboxdeclineargradient2 =
    Color.fromARGB(117, 170, 163, 151);
const Color drawerscreenboxdeclineargradient3 =
    Color.fromARGB(117, 220, 182, 104);
const Color drawerscreentextcolor = Colors.white;
const Color drawerscreeniconcolor = Colors.white;
const Color drawerscreendivcolor = Colors.white;
const Color drawerscreendividercolor = Colors.transparent;
const Color drawerscreenexpansiontilecolor = Color.fromARGB(255, 255, 254, 254);
...
const Color secondContainerColor = Color.fromARGB(255, 16, 16, 16);
Color circularImageBorderColor = Colors.orange.shade800;
...
const Color bigContainerBorderColor = Color.fromARGB(255, 16, 16, 16);
// const Color settingsIconColor = Color.fromARGB(255, 16, 16, 16);
Color settingsIconColor = Colors.orange.shade800;
// const Color settingsTextColor = Color.fromRGBO(107, 49, 20, 1);
const Color settingsTextColor = Color.fromARGB(255, 16, 16, 16);
const Color angleUpIconColor = Colors.cyan;
// const Color angleDownIconColor = Colors.black;
Color angleDownIconColor = Colors.orange.shade800;
// const Color addressTextIconColor = Color.fromARGB(255, 16, 16, 16);
Color addressTextIconColor = Colors.orange.shade800;
// const Color addressTextColor = Color.fromRGBO(107, 49, 20, 1);
const Color addressTextColor = Color.fromARGB(255, 16, 16, 16);
// const Color SettingsangleRightIconColor = Colors.black;
Color SettingsangleRightIconColor = Colors.orange.shade800;

//---------------------------->Profile------->profile_menu_item
// const Color leadingIconColor = Color.fromARGB(255, 16, 16, 16);
Color leadingIconColor = Colors.orange.shade800;
// const Color titleColor = Color.fromRGBO(107, 49, 20, 1);
const Color titleColor = Color.fromARGB(255, 16, 16, 16);
// const Color trailingIconColor = Colors.black;
Color trailingIconColor = Colors.orange.shade800;
...
const Color profileTextColor = Color.fromARGB(255, 16, 16, 16);
// const Color nameTextColor = Color.fromRGBO(137, 71, 37, 1);
const Color nameTextColor = Color.fromARGB(255, 16, 16, 16);
Color inputFillColor = Colors.grey.shade300;
Color inputEnabledBordersideColor = Colors.grey.shade500;
Color inputFocusedBordersideColor = Colors.grey.shade700;
// const Color emailTextColor = Color.fromRGBO(137, 71, 37, 1);
const Color emailTextColor = Color.fromARGB(255, 16, 16, 16);
// const Color saveElevatedButtonBackgroundColor = Color.fromRGBO(137, 71, 37, 1);
const Color saveElevatedButtonBackgroundColor = Color.fromARGB(255, 16, 16, 16);

//---------------------------->Profile------->reusable_widget
const Color comingsoonTextColor = Colors.white;
const Color comingsoonTexticonColor = Colors.white;

//---------------------------->Profile------->my orders
const Color noOrderTextColor = Colors.white;
const Color noOrderTexticonColor = Colors.white;
const Color headingNameColor = Colors.white;
const Color everyOrderContainerShadowColor = Color.fromARGB(255, 28, 28, 29);
...
Color headingcolor = Colors.orange.shade700;
Color tagcolor = Colors.orange.shade700;
const Color cartLinearGrad1 = Colors.black;
const Color cartLinearGrad2 = Color.fromARGB(255, 17, 17, 19);
const Color cartLinearGrad3 = Color.fromARGB(255, 62, 64, 66);

//feeback color constants
const Color selectedyes = Colors.green;
const Color notselected = Colors.grey;
const Color feedbacktextcolor = Colors.white;
const Color feedbackselectedno = Colors.red;
const Color feedbackcollapsebgcolor = Color.fromARGB(255, 134, 89, 22);
const Color feedbackcollapsebackgroundcolor = Color.fromARGB(255, 224, 169, 30);
const Color feedbackcollapsetextcolor = Colors.white;
const Color feedbackcursorrcolor = Colors.orange;
const Color feedbackblack = Colors.black;
...
const Color detailsproductnamecolor = Colors.black;
const Color detailspageratingstarcolor = Colors.amber;
const Color detailsratingcolor = Colors.black;
...
const Color bgcontainercolor = Colors.transparent;

//loadingscreen
Color loadinggradientcolor1 = Colors.white.withOpacity(0.1);
Color loadinggradientcolor2 = Colors.white.withOpacity(0.5);
Color loadingbordercolor = Colors.white.withOpacity(0.2);
Color loadinglineargracolor1 = Colors.white.withOpacity(0.1);
Color loadinglineargracolor2 = Colors.white.withOpacity(0.5);
Color loadingbordercolor2 = Colors.white.withOpacity(0.2);
const Color loadingtextcolor = Colors.black;

//offerings&popular
const Color offeringgradientcolor1 = Colors.transparent;
const Color offeringgradientcolor2 = Colors.black;
const Color offeringiconstarcolor = Colors.amber;
const Color offeringcardshadowcolor = Colors.grey;

//splashscreen
const Color spalshscreensweepgradientcolor1 = Color.fromRGBO(239, 222, 216, 1);
const Color splashscreensweepgradientcolor2 =
    Color.fromARGB(255, 234, 226, 226);
const Color splashscreensweepgradientcolor3 =
    Color.fromARGB(255, 211, 206, 182);

//payment
const Color cardpaymentlineargradient1 = Color.fromRGBO(255, 136, 102, 0.67);
const Color cardpaymentlineargradient2 = Color.fromRGBO(255, 221, 136, 0.28);
const Color cardpaymentcolor = Color.fromARGB(255, 37, 2, 2);
const Color cardpaymentforegroundcolor = Color(0xff1b447);
const Color paymenttextcolor = Colors.white;
Color mypopupgradientcolor1 = Colors.white.withOpacity(0.1);
...
//btncolor
const Color upibtncolor = Colors.white;
...
Color glasscontainerStarIconColor = Colors.orange.shade700;
...
Color glasscontainerDiscountColor = Colors.orange.shade700;
...
const Color descriptiontextColor = Colors.white;
const Color descriptionColor = Color.fromARGB(255, 221, 221, 221);
Color descriptionMoreStyleColor = Colors.orange.shade700;
Color descriptionLessStyleColor = Colors.orange.shade700;
const Color sizeText1Color = Colors.white;
const Color sizeText2Color = Colors.white;
const Color sizeActiveColor = Color.fromRGBO(143, 93, 58, 1);
const Color sizeInactiveColor = Colors.white;
const Color sizeActiveBorderColor = Color.fromARGB(255, 20, 20, 19);
Color sizeInactiveBorderColor = Colors.grey.shade800;
const Color sizeNameActiveColor = Colors.white;
const Color sizeNameInactiveColor = Colors.black;
const Color suggestionTextColor = Colors.white;
const Color suggestionCardShadowColor = Colors.grey;
Color suggestionCardIconColor = Colors.orange.shade700;
Color suggestionCardDiscountColor = Colors.orange.shade700;

//3rd positioned widget
const Color container_Color = Colors.white;
Color container_ShadowColor = Colors.grey.withOpacity(0.5);
const Color elevatedButtonBackgroundColor = Color.fromARGB(255, 173, 86, 31);
const Color elevatedButtonIconColor = Colors.white;
const Color elevatedButtonTextColor = Colors.white;
const Color outlinedButtonIconColor = Color.fromARGB(255, 255, 117, 31);
const Color outlinedButtonTextColor = Color.fromARGB(255, 255, 117, 31);
const Color outlinedButtonSideColor = Color.fromARGB(255, 173, 86, 31);

//bottomSheet
const Color bottomsheetContainerColor = Colors.black;
const Color bottomsheetDividerColor = Colors.white;
const Color bottomsheetDoneIconColor = Colors.green;
const Color outlinedButtonShopping_cartIconColor =
    Color.fromARGB(255, 255, 117, 31);
const Color outlinedButton_TextColor = Color.fromARGB(255, 255, 117, 31);
const Color outlinedButton_SideColor = Color.fromARGB(255, 173, 86, 31);
const Color elevatedButton_BackgroundColor = Color.fromARGB(255, 173, 86, 31);
const Color elevatedButtonShopping_bagIconColor = Colors.white;
...
const Color starcolor = Colors.orange;
const Color commentbox = Colors.white;
Color feedbackbgcolor = Colors.grey.shade900;
const Color commentboxcolor = Colors.grey;
const Color textcursorcolor = Colors.black;
const Color isclickedcolor = Colors.orange;
const Color notclickedcolor = Colors.grey;
const Color submitcolor = Colors.white;
